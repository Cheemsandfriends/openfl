...
#if (haxe >= "4.2.0")
var application(get, never):Application;
var current(get, never):MovieClip;

extern inline function as<T>(v:Dynamic, c:Class<T>):Null<T>
{
	return Lib.as(v, c);
}

extern inline function attach(name:String):MovieClip
{
	return Lib.attach(name);
}
...
/**
	...
	in the following:
**/
extern inline function clearInterval(id:UInt):Void
{
...
/**
	...
	the following
**/
extern inline function clearTimeout(id:UInt):Void
{
	Lib.clearTimeout(id);
}

#if flash
extern inline function eval(path:String):Dynamic
{
	return Lib.eval(path);
}
#end

#if flash
extern inline function fscommand(cmd:String, ?param:String)
{
	return Lib.fscommand(cmd, param);
}
#end
...
/**
	...
	@throws	ReferenceError	No public definition exists with the specified name.
**/
extern inline function getDefinitionByName(name:String):Class<Dynamic>
{
...
/**
	...
	@returns	String	A string containing the fully qualified class name.
**/
extern inline function getQualifiedClassName(value:Dynamic):String
{
	
	return Lib.getQualifiedClassName(value);
}
...
**/
extern inline function getQualifiedSuperclassName(value:Dynamic):String
{
	return Lib.getQualifiedSuperclassName(value);
}
...
/**
	...
	SWF file was loaded.
**/
extern inline function getTimer():Int
{
	return Lib.getTimer();
}
...
/**
	...
	instead.
**/
extern inline function describeType(value:Dynamic):Xml
{
	return Lib.describeType(value);
}

extern inline function getURL(request:URLRequest, target:String = null):Void
{
	navigateToURL(request, target);
}
...
/**
	...
	* You cannot connect to commonly reserved ports. For a complete list of blocked
	...
	@throws	Error	If the method is not called in response to a user action, such as a
		...
		Player and to non-application sandbox content in Adobe AIR.
**/
extern inline function navigateToURL(request:URLRequest, window:String = null):Void
{
...
/**
	...
	characters.
**/
extern inline function encodeURIComponent(value:String):String
	return Lib.encodeURIComponent(value);
...
/**
	...
	function are restored to their uncoded representation.
**/
extern inline function decodeURIComponent(value:String):String
	return Lib.decodeURIComponent(value);

extern inline function notImplemented(?posInfo:PosInfos):Void
	Lib.notImplemented(posInfo);

extern inline function preventDefaultTouchMove():Void
{
	Lib.preventDefaultTouchMove();
}

#if flash
extern inline function redirectTraces()
{
	return flash.Lib.redirectTraces();
}
#end
...
/**
	...
	* If the POST operation is cross-domain (the POST target is not on the same server
	...
	_OpenFL Developer's Guide_.
**/
extern inline function sendToURL(request:URLRequest):Void
{
	Lib.sendToURL(request);
}
...
**/
extern inline function setInterval(closure:Function, delay:Int, args:Array<Dynamic> = null):UInt
{
	return Lib.setInterval(closure, delay, args);
}
...
/**
	...
	cancel the process, by calling the `clearTimeout()` method.
**/
extern inline function setTimeout(closure:Function, delay:Int, args:Array<Dynamic> = null):UInt
{
	return Lib.setTimeout(closure, delay, args);
}
...
/**
	...
	element or attribute.
**/
extern inline function isXMLName(name:String):Bool
	return Lib.isXMLName(name);
...
/**
	...
	This method does not interact with `getDefinitionByName()` method.
**/
extern inline function getClassByAlias(aliasName:String):Class<Dynamic>
	return Lib.getClassByAlias(aliasName);
...
/**
	...
	serializes.
**/
extern inline function registerClassAlias(aliasName:String, classObject:Class<Dynamic>):Void
{
	return Lib.registerClassAlias(aliasName, classObject);
}

// Get & Set Methods
@:noCompletion private extern inline function get_application():Application
{
	return Lib.application;
}

@:noCompletion private extern inline function get_current():MovieClip
{
	return Lib.current;
}
#end
